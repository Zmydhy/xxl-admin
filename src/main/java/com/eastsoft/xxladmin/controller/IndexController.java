...
public class IndexController {
	...
	@ResponseBody
	@PermissionLimit(limit=false)
	public ReturnT<String> loginDo(HttpServletRequest request, HttpServletResponse response,@RequestBody Map<String, String> loginMap ){
		String ifRemember = loginMap.get("ifRemember");
